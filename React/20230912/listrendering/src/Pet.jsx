    ...
    return (
        <form onSubmit={handleSubmit}>
            <fieldset>
                ...
                <label>
                    이름 :
                    <input type="text" value={name} onChange={(event) => setName(event.target.value)} placeholder='이름'/>
                </label>
                <label>
                    종류 :
                    <input type="text" value={species} onChange={(event) => setSpecies(event.target.value)} placeholder='species' />
                </label>
                <label>
                    나이 :
                    <input type="number" value={age} onChange={(event) => setAge(event.target.value)} placeholder='나이' />
                </label>
                <button>추가하기</button>
            </fieldset>
        </form>
