...
// } 
    ...
    const uploadImage = async (imageFile) => {
        ...
        const res = await fetch(reqUrl, {
            method: "POST",
            // fetch headers 기본값이 {"Content-type" : "multipart/form-data"}이므로 header를 적지 않는다.
            body: form
        })
        const json = await res.json();
    ...
    return(
        ...
        <section>
            ...
            <input multiple={true} onChange={handleChangeImage} type="file" id="profileImg" name="image" accept="image/*" />
            <div >
