...
let height =0;
console.log(height ?? 100) // 0이 null 인가요? 아니니까 0을 출력. nullish 입장에서는 0도 value 입니다.
...
let height3 = '';
console.log(height3 ?? 'world') // ''이 null인가요? 아니니까 ''
console.log(height3 || 'hello') // ''을 만났을 때 봐야 하나요?
...
let username='';
let nickname='';
console.log(username ?? nickname ?? 'guest') // 없음
